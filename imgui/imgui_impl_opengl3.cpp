...
bool    ImGui_ImplOpenGL3_CreateDeviceObjects()
{
    ...
    const GLchar* fragment_shader_glsl_120 =
        ...
        "#endif\n"
        "uniform sampler2D TextureType;\n"
        "varying vec2 Frag_UV;\n"
        "varying vec4 Frag_Color;\n"
        "void main()\n"
        "{\n"
        "    gl_FragColor = Frag_Color * texture2D(TextureType, Frag_UV.st);\n"
        "}\n";
    ...
    const GLchar* fragment_shader_glsl_130 =
        ...
        "void main()\n"
        "{\n"
        "    Out_Color = Frag_Color * texture(TextureType, Frag_UV.st);\n"
        "}\n";
    ...
    bd->AttribLocationTex = glGetUniformLocation(bd->ShaderHandle, "TextureType");
